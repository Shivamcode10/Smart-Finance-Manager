...
import { CalculatorIcon, CalculatorDarkIcon, CalculatorBlueIcon, CalculatorMiniIcon } from './src/components/icons';
...
const FloatingCalculatorButton = () => {
  ...
  return (
    <>
      ...
      >
        <CalculatorIcon className="h-6 w-6" /> {/* <-- USE THE NEW ICON */}
