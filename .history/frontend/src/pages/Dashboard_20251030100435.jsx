...
import FinancialCalendar from '../components/FinancialCalendar'; // <-- ADD THIS LINE
...
const Dashboard = () => {
  const {
    ...
    getBudgets,
    getAlerts,
    addTransaction, // Added this to access the addTransaction function
    stats,
    transactions,
    goals,
    budgets,
  ...
  return (
    <div>
      ...
      <div className="mb-6">
        <VoiceCommands addTransaction={addTransaction} />
      </div>
      ...
      {/* ADD THE FINANCIAL CALENDAR HERE */}
      <div className="mb-6">
        <FinancialCalendar />
      </div>
